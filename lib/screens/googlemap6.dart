...
class googlemap6 extends StatefulWidget {
  const googlemap6({Key? key}) : super(key: key);

  @override
  _googlemapState createState() => _googlemapState();
}

class _googlemapState extends State<googlemap6> {
  ...
  final List<Marker> _list=const[
    ...
    Marker(markerId: MarkerId("3"),
        position: LatLng(6.885224881767704, 79.88181109547722),
        infoWindow: InfoWindow(
            title: "Ayurveda Seth Arana"
        )
    ),
  Marker(markerId: MarkerId("3"),
  position: LatLng(6.970790280411586, 79.87674081522904),
  infoWindow: InfoWindow(
  title: "CMC Ayurvedic Dispensary"
  ),),
  ];
