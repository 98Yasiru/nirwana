...
class googlemap7 extends StatefulWidget {
  const googlemap7({Key? key}) : super(key: key);

  @override
  _googlemapState createState() => _googlemapState();
}

class _googlemapState extends State<googlemap7> {
  ...
  final List<Marker> _list=const[
    ...
    Marker(markerId: MarkerId("3"),
        position: LatLng(7.936131703116098, 80.63216037167355),
